    ...
    <div class="row py-5">
        ...
        <div class="col-2 my-5 py-5 bg-light">
            <form onsubmit="return false" method="post">
                ...
                <button id="login" class="btn btn-primary ml-2">登录</button>
                <button type="reset" class="btn btn-primary ml-2">重置</button>
            </form>
            <a href="/toRegisterBusiness">免费注册</a>
        </div>
    </div>
</div>
        ...
        $("#login").click(function (t) {
            $.ajax({
                ...
                success:function (data) {
                    if ($("#userName").val()==data.username&&$("#pwd").val()==data.password){
                        alert("登录成功")
                        window.location.href="/toPersonalCenterBusiness"
